 ...
 * </div>
 */
const blurhashImage = tv({
  slots: {
    wrapper: "relative shadow-black/5",
    zoomedWrapper: "relative overflow-hidden rounded-inherit",
    img: "relative top-0 left-0 z-10 opacity-0 shadow-black/5 data-[loaded=true]:opacity-100",
    placeholder: "absolute top-0 left-0 inset-0 z-0",
    blurredImg: [
      "absolute",
      "z-0",
      "inset-0",
...
export type BlurhashImageVariantProps = VariantProps<typeof blurhashImage>;
export type BlurhashImageSlots = keyof ReturnType<typeof blurhashImage>;
